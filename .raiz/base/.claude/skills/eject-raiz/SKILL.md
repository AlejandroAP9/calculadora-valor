---
name: eject-raiz
description: "DESTRUCTIVO: Eliminar Raíz del proyecto y dejar solo el software funcional. Activar cuando el usuario dice: quiero quitar Raíz, eject, remover el template, limpiar el proyecto, o distribuir el codigo sin el bosque. SIEMPRE confirmar antes de ejecutar."
...
Modifica estos archivos para quitar referencias a Raíz:
...
2. **No hay vuelta atras** - Para recuperar SF, tendrias que volver a ejecutar el alias `raiz`
